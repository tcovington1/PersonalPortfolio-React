...
const projectData = [
  {
    ...
    about: 'During my part-time full-stack web dev bootcamp at DevPoint Labs I was assigned to GenHu with 4 other developers. Our goal was to rebuild GenHu.org, a local non-profit site. This site is built with a Ruby on Rails back-end giving our client access to an admin page. We then used React.js for the front-end. ',
    image: {genhuImage},
  },
];
